 ...
 *
 * Submitting POSTs the email to Supabase, which mails a one-time link.
 * The link points to /auth/callback?code=...&next=... where the server
 * exchanges the code for a session and redirects into the app.
 *
 * `next` flows through from any redirect-from-middleware so the user
