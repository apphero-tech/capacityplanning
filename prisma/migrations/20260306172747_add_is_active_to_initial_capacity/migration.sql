...
INSERT INTO "new_InitialCapacity" ("design", "development", "firstName", "ftPt", "hrsPerWeek", "id", "kt", "lastName", "lead", "location", "other", "pmo", "qa", "refinement", "role") SELECT "design", "development", "firstName", "ftPt", "hrsPerWeek", "id", "kt", "lastName", "lead", "location", "other", "pmo", "qa", "refinement", "role" FROM "InitialCapacity";
